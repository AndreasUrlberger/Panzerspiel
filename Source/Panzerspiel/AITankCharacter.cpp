...
void AAITankCharacter::MoveRight(float AxisValue) {
    // Do nothing.
}

AAITankCharacter::AAITankCharacter() {
...
bool AAITankCharacter::MoveTo(FVector TargetLocation, float DeltaTime) {
...
void AAITankCharacter::NavigationTrace() {
...
void AAITankCharacter::Tick(float DeltaTime) {
